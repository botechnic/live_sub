package
{
    ...
    public class Main extends Sprite
    {
		...
		private var audio_timer:Timer = new Timer(100);
        ...
        */
        ...
        private function system_on_js_ready():void {
            ...
            ExternalInterface.addCallback("set_volume", this.setVolume);
			ExternalInterface.addCallback("get_volume", this.getVolume);
			
            flash.external.ExternalInterface.call(this.js_on_player_ready, this.js_id);
			
			audio_timer.addEventListener(TimerEvent.TIMER, audio_info);
			audio_timer.start();
        ...
        *       use user specified height if -1.
        ...
        private function js_call_play(url:String, _width:int, _height:int, buffer_time:Number, volume:Number):void {
            ...
            this.media_conn.addEventListener(NetStatusEvent.NET_STATUS, function(evt:NetStatusEvent):void {
				...
				//channel.soundTransform = media_stream.soundTransform;
		...
		private function setVolume(volumeChange:Number):void {
			if (media_stream.soundTransform != null) {
				var transform:SoundTransform = media_stream.soundTransform;
				//transform.volume = Math.max(0, Math.min(1, volumeChange));
				transform.volume = volumeChange;
				media_stream.soundTransform = transform;
				ExternalInterface.call("onActivityLevel", volumeChange * 100);			
			}
		}
		...
		private function audio_info(e:TimerEvent):void {
			//ExternalInterface.call("onActivityLevel", media_stream.soundTransform.volume * 100);			
		}
